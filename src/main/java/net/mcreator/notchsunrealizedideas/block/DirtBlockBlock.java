...
public class DirtBlockBlock extends NotchsUnrealizedIdeasModElements.ModElement {
	@ObjectHolder("notchs_unrealized_ideas_:dirt_block")
	public static final Block block = null;
	public DirtBlockBlock(NotchsUnrealizedIdeasModElements instance) {
		super(instance, 2);
	}
