...
public class GrassBlockBlock extends NotchsUnrealizedIdeasModElements.ModElement {
	@ObjectHolder("notchs_unrealized_ideas_:grass_block")
	public static final Block block = null;
	public GrassBlockBlock(NotchsUnrealizedIdeasModElements instance) {
		super(instance, 1);
	}
